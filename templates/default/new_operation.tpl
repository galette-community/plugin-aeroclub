{if $enregistre}
<div id="infobox">
<h1>{_T string="NEW OPERATION.ENREGISTRE OK"}</h1>
</div>
{/if}
{if $pas_enregistre}
<div id="warningbox">
<h1>{_T string="NEW OPERATION.PAS ENREGISTRE"}</h1>
</div>
{/if}
...
<div class="bigtable">
    <fieldset class="cssform">
        ...
        <div>
            ...
            <select name="sel_type_operation" id="adherent_id">
                ...
                {/foreach}
                <option value="-null-">Autre (préciser)</option>
            </select>
            ou autre : <input type="text" name="autre_type_operation">
            </p>
            <p>
    ...
    <fieldset class="cssform">
        ...
        <div>
            ...
            ou autre : <input type="text" name="autre_type_vol">
            </p>
            <p>
            <span class="bline">{_T string="NEW OPERTATION.AEROPORT"}</span>
            Départ : <input type="text" size="4" name="depart" value="{$operation->aeroport_depart}"> /
            Arrivée : <input type="text" size="4" name="arrivee" value="{$operation->aeroport_arrivee}">
            </p>
            <p>
...
<script type="text/javascript">
    $(function() {ldelim}
        $('#date_operation').datepicker({ldelim}
            changeMonth: true,
            changeYear: true,
            showOn: 'both',
