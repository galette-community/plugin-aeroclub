    ...
    <div id="prefs_tabs">
        ...
        <fieldset id="tableau" class="cssform">
            ...
            <table class="listing">
                <thead>
                    <tr>
                        <th><a href="?tri=avion&direction={if $tri eq 'avion' && $direction eq 'asc'}desc{else}asc{/if}">{_T string="HEURES.AVION"}</a>{if $tri eq 'avion' && $direction eq 'asc'} <img src="{$template_subdir}images/down.png">{elseif $tri eq 'avion' && $direction eq 'desc'} <img src="{$template_subdir}images/up.png">{/if}</th>
